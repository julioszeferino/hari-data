...
def main(params):
    ...
    spark = hari.criaSessaoSpark(spark, salvarMetricas=True, nivelLogSpark="ERROR", "job_cria_tabela_intermediaria2") 
    ...
    hari.salvarTabela("silver.tabela5", formato="delta")

    hari.metadados.incluirDependenciaDestino("silver.tabela5")
